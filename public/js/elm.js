...
var _user$project$Types$ThreeOfAKind = {ctor: 'ThreeOfAKind'};
var _user$project$Types$Straight = {ctor: 'Straight'};
var _user$project$Types$Flush = {ctor: 'Flush'};
var _user$project$Types$FullHouse = {ctor: 'FullHouse'};
var _user$project$Types$FourOfAKind = {ctor: 'FourOfAKind'};
var _user$project$Types$StraightFlush = {ctor: 'StraightFlush'};
var _user$project$Types$RoyalFlush = {ctor: 'RoyalFlush'};

var _user$project$CardHelpers$dealHand2 = function (model) {
	var test = A2(
		_elm_lang$core$List$map,
		function (player) {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$CardHelpers$createPlayers = function (numPlayers) {
	return A2(
		_elm_lang$core$List$map,
		function (_p0) {
			return {
...
var _user$project$CardHelpers$getTopCard = function (cardList) {
	return A2(
...
var _user$project$CardHelpers$twoPair = function (cardList) {
	var groupedCards = _elm_community$list_extra$List_Extra$group(
		A2(
			...
			cardList));
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(groupedCards),
		3) && A2(
		_elm_lang$core$List$any,
		function (list) {
			return _elm_lang$core$Native_Utils.eq(
...
var _user$project$CardHelpers$flush = function (cardList) {
	var firstcardsuit = function (_) {
		...
		_user$project$CardHelpers$getTopCard(cardList));
	return A2(
		_elm_lang$core$List$all,
		function (card) {
			return _elm_lang$core$Native_Utils.eq(card.suit, firstcardsuit);
		},
		cardList);
};
var _user$project$CardHelpers$straight = function (cardList) {
	...
	var headValue = function (_) {
		...
		_user$project$CardHelpers$getTopCard(head));
	...
	return A2(
		...
		function (card) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('bg-center contain w5 inline-flex'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_0: {
									...
									_1: A2(
										_elm_lang$core$Basics_ops['++'],
										'url(',
										A2(_elm_lang$core$Basics_ops['++'], card.image, ')'))
								},
								_1: {
									ctor: '::',
...
var _user$project$Request$getCardsFromApi = A2(
	...
	A2(_elm_lang$http$Http$get, 'https://api.myjson.com/bins/ot0r1', _user$project$Request$cardListDecoder));
				...
				if (_p0._0.ctor === 'Ok') {
					return {
						...
						_1: A2(
							...
							_elm_community$random_extra$Random_List$shuffle(_p0._0._0))
					};
				} else {
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Deal hand'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Check hand'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(model.handType)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Reshuffle deck'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
